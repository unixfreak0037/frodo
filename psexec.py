...
# of the Apache Software License. See the accompanying PSEXEC_LICENSE file
# for more information.
#
# $Id: psexec.py 608 2012-07-15 02:59:58Z bethus@gmail.com $
#
    ...
    def doStuff(self, rpctransport):
        ...
        try:
            ...
            if self.__path is not None:
                print "setting WorkingDir to {0}".format(self.__path)
